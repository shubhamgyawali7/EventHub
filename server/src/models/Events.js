...
const eventSchema = new mongoose.Schema({
  ...
  category: {
    type: String,
    required: true,
    enum: ["Workshop", "Competition", "Hackathon", "Seminar", "Meetup", "Conference", "Other"],
  },
  ...
  organizer: { type: mongoose.Schema.Types.ObjectId, ref: "RegisterClub", default: null },
  ...
  location: {
    ...
    coordinates: { type: [Number], default: [85.324, 27.717] }, // [Long, Lat]
  },
